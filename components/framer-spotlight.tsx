...
export default function FramerSpotlight() {
  ...
  const spotlightColors = [
    { color: "rgba(8, 145, 178, 0.2)", darkColor: "rgba(8, 145, 178, 0.25)" }, // Primary teal
    { color: "rgba(14, 116, 144, 0.15)", darkColor: "rgba(14, 116, 144, 0.2)" }, // Darker teal
    { color: "rgba(20, 184, 166, 0.15)", darkColor: "rgba(20, 184, 166, 0.2)" }, // Lighter teal
  ]
  ...
  return (
    <div ref={containerRef} className="absolute inset-0 overflow-hidden pointer-events-none">
      ...
      <motion.div
        ...
        style={{
          background: `radial-gradient(circle, ${
            isDark ? "rgba(20, 184, 166, 0.2)" : "rgba(20, 184, 166, 0.15)"
          } 0%, transparent 70%)`,
          width: "550px",
          height: "550px",
          borderRadius: "50%",
